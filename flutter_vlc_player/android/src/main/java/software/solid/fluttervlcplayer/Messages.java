...
public class Messages {
  ...
  /** Generated class from Pigeon that represents data sent in messages. */
  public static class PercentagePositionMessage {
    private Long viewId;
    public Long getViewId() { return viewId; }
    public void setViewId(Long setterArg) { this.viewId = setterArg; }
    ...
    static PercentagePositionMessage fromMap(Map<String, Object> map) {
      PercentagePositionMessage fromMapResult = new PercentagePositionMessage();
      Object viewId = map.get("viewId");
      fromMapResult.viewId = (viewId == null) ? null : ((viewId instanceof Integer) ? (Integer)viewId : (Long)viewId);
      Object position = map.get("position");
  ...
  public interface VlcPlayerApi {
    ...
    void setPosition(PercentagePositionMessage arg);
      ...
      }
      {
        ...
        if (api != null) {
          channel.setMessageHandler((message, reply) -> {
            ...
            try {
              @SuppressWarnings("ConstantConditions")
              PercentagePositionMessage input = PercentagePositionMessage.fromMap((Map<String, Object>)message);
