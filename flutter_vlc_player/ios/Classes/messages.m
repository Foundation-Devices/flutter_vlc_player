...
-(NSDictionary*)toMap;
@end
@interface PercentagePositionMessage ()
+(PercentagePositionMessage*)fromMap:(NSDictionary*)dict;
-(NSDictionary*)toMap;
@end
...
@implementation PercentagePositionMessage
+(PercentagePositionMessage*)fromMap:(NSDictionary*)dict {
  PercentagePositionMessage* result = [[PercentagePositionMessage alloc] init];
  result.viewId = dict[@"viewId"];
  if ((NSNull *)result.viewId == [NSNull null]) {
    result.viewId = nil;
  }
...
void VlcPlayerApiSetup(id<FlutterBinaryMessenger> binaryMessenger, id<VlcPlayerApi> api) {
  ...
  }
  {
    ...
    if (api) {
      [channel setMessageHandler:^(id _Nullable message, FlutterReply callback) {
        PercentagePositionMessage *input = [PercentagePositionMessage fromMap:message];
        FlutterError *error;
        [api setPosition:input error:&error];
        callback(wrapResult(nil, error));
      }];
    }
    else {
